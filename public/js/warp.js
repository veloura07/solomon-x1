...
(function () {
  ...
  // ── 11e. WIRE WS HOOKS (called when invocation UI is live) ────────────
  ...
  function warpUpdate() {
    ...
    var targetSpeed = (window.solomonWS && window.solomonWS.isGenerating)
      ? _warpSpinSpeed += (_WARP_GEN_SPEED - _warpSpinSpeed) * 0.08
      : _warpSpinSpeed += (_WARP_IDLE_SPEED - _warpSpinSpeed) * 0.08;
